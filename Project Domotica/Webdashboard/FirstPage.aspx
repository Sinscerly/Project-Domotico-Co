...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="Content"> 
        ...
        <p>
            ...
            <asp:Button ID="Country_Guessing" runat="server" Height="38px" Text="Rock Paper Scissors" Visible="False" CssClass="Button" PostBackUrl="~/Games/Rock_Paper_Scissors.aspx" />
